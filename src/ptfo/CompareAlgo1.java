 ...
 * @author yougo
 */
public class CompareAlgo1 {

    Connection connexion;
    NaiveBayes nb;

    public CompareAlgo1() throws SQLException {
    ...
    public void compareAlgoAvecHumain(String baseCom, String baseTest) throws SQLException {
        String nomCol="NOTE";
        ...
        while (phraseRecup.next()) {
            ...
            if (phraseTestRecup.next()) {
                System.out.println("Phrase à tester  : " + phraseTestRecup.getString("PHRASE") + "\n" + "Classe : " + phraseTestRecup.getInt(nomCol) + "\n");
                int classeATest = phraseTestRecup.getInt(nomCol);
                if (classeATest != 0) {
                    classeATest = phraseTestRecup.getInt(nomCol) / Math.abs(phraseTestRecup.getInt(nomCol));
                }
                switch (classe) {
                    case 1:
                        noteRefPositif++;
    ...
    public static void main(String[] args) throws SQLException {
        ...
        CompareAlgo1 nettoyage;
        nettoyage = new CompareAlgo1();
        //nettoyage.ameliorationPhrase();
        nettoyage.compareAlgoAvecHumain("PHRASE_HY_TEST_2", "PHRASE_HY_TEST_2");
    }
